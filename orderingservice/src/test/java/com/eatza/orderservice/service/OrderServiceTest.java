...
public class OrderServiceTest {
    ...
    @Mock
    private DeliverServiceClient deliveryServiceClient;
...
lenient().when(deliveryServiceClient.loggingOrder(any(DeliveryResponseDto.class)))
        .thenReturn(new ResponseEntity<DeliveryResponseDto>(deliverItem, HttpStatus.OK));
